...
/*   Updated: 2022/05/31 14:59:36 by plouvel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string const & target) : _name(target), _hitPoints(10),
										_energyPoints(10), _dealingDamage(0)
{
...
ClapTrap &	ClapTrap::operator=(ClapTrap const & rhs)
{
	...
	this->_dealingDamage = rhs._dealingDamage;
	return (*this);
}
...
void	ClapTrap::attack(std::string const & target)
{
	if (this->_hitPoints > 0)
	{
		...
		{
			this->_energyPoints--;
			std::cout << "ClapTrap \"" << this->_name << "\" attacks \"" << target << "\", causing " << this->_dealingDamage << " points of damage !" << std::endl;
		}
		else
