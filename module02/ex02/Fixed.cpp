...
Fixed::Fixed(void) : _n(0), _isFloat(false)
{
#ifdef DEBUG_MSG
...
Fixed::Fixed(int const n) : _n(n << _nbrBits), _isFloat(false)
{
#ifdef DEBUG_MSG
...
Fixed::Fixed(float const f) : _n(roundf(f * (1 << _nbrBits))), _isFloat(true)
{
#ifdef DEBUG_MSG
...
void	Fixed::setNbrType(bool const isFloat)
{
	this->_isFloat = isFloat;
}

bool	Fixed::getNbrType(void) const
{
